...
const query = async function () {
    try {
        const response = await fetch('https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=vote_average.desc&page=1&timezone=America%2FNew_York&vote_count.gte=7000&include_null_first_air_dates=false&with_watch_monetization_types=flatrate');
        ...
        data.results.forEach((TVshows) => {
            ...
            <div class="tv-card-back">
              <h2 class="tv-card-header">${tv.original_name}</h2>
              <div class="scorebox">
